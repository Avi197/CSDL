...
namespace HelloWorldReact.Controllers
{
    ...
    public class CourseController : Controller
    {
        ...
        //    int ret = 0;
        //    COURSE_BUS bus = new COURSE_BUS();
        //    COURSE_OBJ obj = bus.GetByID(new COURSE_OBJ.BusinessObjectID(id));
        ...
        ///// </summary>
        //public JsonResult update(COURSE_OBJ obj, string keysearchCodeView, string keysearchName)
        //{
        //    if (ses.func("ADMINDIRE") <= 0)
        //    {
        //        return Json(new { sussess = -3 }, JsonRequestBehavior.AllowGet);
        ...
        //    COURSE_OBJ obj_temp = null;
        //    //kiểm tra tồn tại cho trường hợp sửa
        //    if (!string.IsNullOrEmpty(obj.CODE))//edit
        //    {
        //        obj_temp = bus.GetByID(new COURSE_OBJ.BusinessObjectID(obj.CODE));
